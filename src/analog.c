...
static GFont s_res_lcd_phone_font_26;
...
static void initialise_ui(void) {
  ...
  s_res_lcd_phone_font_26 = fonts_load_custom_font(resource_get_handle(RESOURCE_ID_LCD_PHONE_FONT_26));
  // s_layer_1
  ...
  text_layer_set_font(s_textlayer_1, s_res_lcd_phone_font_26);
...
static void destroy_ui(void) {
  ...
  fonts_unload_custom_font(s_res_lcd_phone_font_26);
}
